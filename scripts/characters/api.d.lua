...
--- Opens a message textbox with the text provided. The text of this message
--- is localized.
---@param text_key string The key for the text to display.
function message (text_key) end
